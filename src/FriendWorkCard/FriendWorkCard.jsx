  ...
  render() {
    return (
      <SynarenCard
        ...
        header={<a target="_blank" className="uk-link-heading" href={"https://www.synaren.com/friendwork"}>FriendWork</a>}
        link={
          <a target="_blank" className="uk-link-heading" style={{ marginLeft: "4px", transform: "translateY(-10%)", color: "black" }} href={"https://www.synaren.com/friendwork"} uk-icon="link">
