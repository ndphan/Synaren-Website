  ...
  render() {
    return (
      <SynarenCard
        ...
        header={<a target="_blank" rel="noopener noreferrer" className="uk-link-heading" href={"http://movskivr.synaren-app.com/"}>MovskiVR</a>}
        link={
          <a target="_blank" rel="noopener noreferrer" className="uk-link-heading" style={{ marginLeft: "4px", transform: "translateY(-10%)", color: "white" }} href={"http://movskivr.synaren-app.com/"} uk-icon="link">
