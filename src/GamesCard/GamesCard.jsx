  ...
  render() {
    return (
      <SynarenCard
        ...
        link={
          <a target="_blank" rel="noopener noreferrer" className="uk-link-heading" style={{ marginLeft: "4px", transform: "translateY(-10%)", color: "black" }} href={"https://games.synaren-app.com/"} uk-icon="link">
