...
import { ArticleItem, ArticleTrigger, ArticleLink, ArticleText, Boundary } from './ArticleMenu.styles.js';
  ...
  return articles.map((item, index) => {
    ...
    return (
      <ArticleItem
        key={index}
      >
        <ArticleLink className="uk-link" target="_blank" rel="noopener noreferrer" href={`https://synaren-blog.com${articleRoute}`} onClick={onClick}>
